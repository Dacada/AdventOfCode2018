// Figure out the values for the mystery jmps
...
int main(void) {
 ...
 lbl08:
  ...
  if (r1 == 1) goto lbl12; // 10 rjmp r1
  goto lbl3;               // 11 jmp 2
 lbl12:
  r3 += 1;                 // 12 addi 3 1 3
  r1 = r3 > r5 ? 1 : 0;    // 13 gtrr 3 5 1
  if (r1 == 1) goto lbl16; // 14 rjmp r1
  goto lbl2;               // 15 jmp 1
 lbl16:
  goto end;                // 16 rjmp r4*r4
 lbl17:
  r5 += 2;                 // 17 addi 5 2 5
  r5 *= r5;                // 18 mulr 5 5 5
  r5 *= 19;                // 19 mulr 4 5 5
